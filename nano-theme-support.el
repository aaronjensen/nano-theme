...
(defun nano-theme (theme mode)
  ...
  (let ((light     '((background light)))
    ...
    (if nano-window-divider-show
        (custom-theme-set-faces theme
         `(window-divider ((,light (:foreground ,nano-light-subtle))
   ...
   `(fringe                      ((,light (:foreground ,nano-light-fringe
                                                       :background unspecified
                                                       :inherit nano-faded))
                                   (,dark (:foreground ,nano-dark-fringe
                                                       :background ,nano-dark-background
                                                       :inherit nano-faded))))
   ...
   '(line-number-current-line     ((t (:inherit (nano-strong)))))
   ...
   ;; --- Dired --------------------------------------------------------
   '(dired-directory                      ((t (:inherit nano-strong))))
   ...
   `(evil-mc-cursor-default-face          ((,light (:background ,nano-light-cursor-alt))
                                           (,dark (:background ,nano-dark-cursor-alt))))

   ;; --- Terraform Mode -----------------------------------------------
   '(terraform--resource-name-face        ((t (:inherit nano-popout))))
   '(terraform--resource-type-face        ((t (:inherit nano-popout))))

   ;; --- LSP Mode ----------------------------------------------------
   '(lsp-face-highlight-read              ((t (:inherit nano-default
                                               :underline t))))
   ...
   ;; --- Magit Delta -------------------------------------------------
   '(magit-diff-added-highlight           ((t (:background "#d0ffd0"))))
   '(magit-diff-added                     ((t (:background "#d0ffd0"
                                               :foreground "#234626"))))
   '(magit-diff-removed-highlight         ((t (:background "#ffe0e0"))))
   '(magit-diff-removed                   ((t (:background "#ffe0e0"
                                               :foreground "#5d272c"))))

   ;; --- Vertico ------------------------------------------------------
   `(vertico-current                      ((t (:inherit nano-subtle))))
   ...
   `(nano-modeline-active               ((,light (:background ,nano-light-background-alt
                                                              :box (:line-width (16 . 5) :color ,nano-light-background-alt :style flat-button)))
                                         (,dark (:background ,nano-dark-background-alt :box (:line-width (16 . 5) :color ,nano-dark-background-alt :style flat-button)))))
   ...
   '(nano-modeline-active-primary       ((t (:inherit (nano-default nano-modeline-active)
                                             :height 0.8))))
   '(nano-modeline-active-secondary     ((,light (:box (:line-width (16 . 5) :color ,nano-light-background-alt :style flat-button)
                                             :inherit (nano-faded nano-modeline-active fixed-pitch)))
                                         (,dark (:box (:line-width (16 . 5) :color ,nano-dark-background-alt :style flat-button)
                                             :inherit (nano-faded nano-modeline-active fixed-pitch)))))
   ...
   ;; --- Fly spell ----------------------------------------------------
   `(flyspell-duplicate             ((,light (:inherit nano-faded :underline (:color ,nano-light-faded :style wave)))
                                     (,dark (:inherit nano-faded :underline (:color ,nano-dark-salient :style wave)))))
   `(flyspell-incorrect             ((,light (:underline (:color ,nano-light-salient :style wave)))
   ...
   '(org-block                               ((t (:inherit hl-line :extend t))))
   `(org-block-begin-line                    ((,light (:inherit nano-faded
                                                       :background ,nano-light-subtle
                                                       :extend t))
                                               (,dark (:inherit nano-faded
                                                       :background ,nano-dark-subtle
                                                       :extend t))))
   `(org-block-end-line                      ((,light (:inherit nano-faded
                                                       :background ,nano-light-subtle
                                                       :extend t))
                                               (,dark (:inherit nano-faded
                                                       :background ,nano-dark-subtle
   ...
   `(org-verbatim                            ((,light (:background ,nano-light-background-alt))
                                              (,dark (:background ,nano-dark-background-alt))))
